...
public record ClaimDto(long CarId, DateOnly ClaimDate, string Description, decimal Amount);
public record HistoryEventDto(string Type, string Description, DateOnly Date);
